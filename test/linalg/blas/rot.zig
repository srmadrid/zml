...
test rot {
    ...
    if (false) {
        ...
        rot(cf64, n, cf64.init(2, 3), x5.ptr, 1, x6.ptr, 1);
        for (0..n) |i| {
        ...
        rot(cf64, n, cf64.init(2, 3), x5.ptr, 1, x7.ptr, -1);
        for (0..n) |i| {
        ...
        rot(cf64, n / 2, cf64.init(2, 3), x5.ptr, 2, x8.ptr, 2);
        for (0..n) |i| {
            if (i % 2 == 0) {
