...
test geru {
    ...
    geru(cf64, .RowMajor, m, n, alpha, x1.ptr, 2, y1.ptr, 2, A.ptr, n);
    ...
    geru(cf64, .RowMajor, m, n, alpha, x2.ptr, -2, y2.ptr, -2, A.ptr, m);
    ...
    geru(cf64, .ColumnMajor, m, n, alpha, x3.ptr, 2, y3.ptr, 2, A.ptr, n);
    ...
    geru(cf64, .ColumnMajor, m, n, alpha, x4.ptr, -2, y4.ptr, -2, A.ptr, m);
