...
test nrm2 {
    ...
    const result1 = nrm2(n, x1.ptr, 1, .{}) catch unreachable;
    try std.testing.expectApproxEqRel(18271.111077326415, result1, 0.0000000001);
    const result2 = nrm2(n / 2, x1.ptr, 2, .{}) catch unreachable;
    ...
    const result3 = nrm2(n, x2.ptr, 1, .{}) catch unreachable;
    try std.testing.expectApproxEqRel(25839.253085180306, result3, 0.0000000001);
    const result4 = nrm2(n / 2, x2.ptr, 2, .{}) catch unreachable;
