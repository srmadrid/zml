...
const combinations = .{
    ...
    .{ .row_major, .upper, @as(usize, 32), @as(isize, 1), @as(isize, 3), @as(usize, 32) },
    .{ .col_major, .upper, @as(usize, 37), @as(isize, -1), @as(isize, 1), @as(usize, 40) },
    .{ .row_major, .lower, @as(usize, 37), @as(isize, 2), @as(isize, -2), @as(usize, 40) },
    .{ .col_major, .lower, @as(usize, 37), @as(isize, -2), @as(isize, -1), @as(usize, 37) },
    .{ .col_major, .upper, @as(usize, 64), @as(isize, 1), @as(isize, -1), @as(usize, 64) },
    .{ .row_major, .lower, @as(usize, 65), @as(isize, -1), @as(isize, 1), @as(usize, 65) },
    .{ .col_major, .lower, @as(usize, 65), @as(isize, 2), @as(isize, -1), @as(usize, 65) },
    .{ .row_major, .upper, @as(usize, 65), @as(isize, -1), @as(isize, 2), @as(usize, 70) },
    .{ .col_major, .upper, @as(usize, 65), @as(isize, -3), @as(isize, -3), @as(usize, 65) },
    ...
    .{ .row_major, .lower, @as(usize, 1500), @as(isize, 1), @as(isize, 2), @as(usize, 1500) },
    .{ .col_major, .upper, @as(usize, 1000), @as(isize, 3), @as(isize, 1), @as(usize, 1005) },
    ...
    .{ .row_major, .lower, @as(usize, 1003), @as(isize, 2), @as(isize, -1), @as(usize, 1010) },
};
