...
test hemv {
    ...
    hemv(cf64, .RowMajor, .Upper, n, alpha, A.ptr, n, x1.ptr, 2, beta, y1.ptr, 2);
    ...
    hemv(cf64, .RowMajor, .Upper, n, alpha, A.ptr, n, x2.ptr, -2, beta, y2.ptr, -2);
    ...
    hemv(cf64, .ColumnMajor, .Upper, n, alpha, A.ptr, n, x3.ptr, 2, beta, y3.ptr, 2);
    ...
    hemv(cf64, .ColumnMajor, .Upper, n, alpha, A.ptr, n, x4.ptr, -2, beta, y4.ptr, -2);
    ...
    hemv(cf64, .RowMajor, .Lower, n, alpha, A.ptr, n, x5.ptr, 2, beta, y5.ptr, 2);
    ...
    hemv(cf64, .RowMajor, .Lower, n, alpha, A.ptr, n, x6.ptr, -2, beta, y6.ptr, -2);
    ...
    hemv(cf64, .ColumnMajor, .Lower, n, alpha, A.ptr, n, x7.ptr, 2, beta, y7.ptr, 2);
    ...
    hemv(cf64, .ColumnMajor, .Lower, n, alpha, A.ptr, n, x8.ptr, -2, beta, y8.ptr, -2);
