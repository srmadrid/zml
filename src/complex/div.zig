...
/// Performs division between two operands of any numeric type in `Complex`
/// precision.
///
/// Signature
/// ---------
/// ```zig
/// fn div(allocator: std.mem.Allocator, x: X, y: Y) !Complex
/// ```
///
/// Parameters
/// ----------
...
pub fn div(allocator: std.mem.Allocator, x: anytype, y: anytype) !Complex(Scalar(Coerce(Rational, Coerce(@TypeOf(x), @TypeOf(y))))) {
