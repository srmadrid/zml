...
/// ---------
/// ```zig
/// fn mul(allocator: std.mem.Allocator, x: X, y: Y) !Complex
/// ```
///
/// Parameters
/// ----------
...
pub fn mul(allocator: std.mem.Allocator, x: anytype, y: anytype) !Complex(Scalar(Coerce(Rational, Coerce(@TypeOf(x), @TypeOf(y))))) {
