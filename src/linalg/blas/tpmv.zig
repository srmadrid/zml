...
pub inline fn tpmv(comptime T: type, order: Order, uplo: Uplo, transA: Transpose, diag: Diag, n: isize, Ap: [*]const T, x: [*]T, incx: isize) void {
    ...
    switch (supported) {
        .BuiltinBool => @compileError("blas.tpmv does not support bool."),
        ...
        .CustomInt, .CustomReal, .CustomComplex, .CustomExpression => @compileError("blas.tpmv only supports simple types."),
...
test "tpmv" {
    ...
    blas.tpmv(f64, .RowMajor, .Upper, .NoTrans, .NonUnit, n, A.ptr, x1.ptr, 2);
    ...
    blas.tpmv(f64, .RowMajor, .Upper, .NoTrans, .Unit, n, A.ptr, x2.ptr, -2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Upper, .NoTrans, .NonUnit, n, A.ptr, x3.ptr, 2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Upper, .NoTrans, .Unit, n, A.ptr, x4.ptr, -2);
    ...
    blas.tpmv(f64, .RowMajor, .Upper, .Trans, .NonUnit, n, A.ptr, x5.ptr, 2);
    ...
    blas.tpmv(f64, .RowMajor, .Upper, .Trans, .Unit, n, A.ptr, x6.ptr, -2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Upper, .Trans, .NonUnit, n, A.ptr, x7.ptr, 2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Upper, .Trans, .Unit, n, A.ptr, x8.ptr, -2);
    ...
    blas.tpmv(f64, .RowMajor, .Lower, .NoTrans, .NonUnit, n, A.ptr, x9.ptr, 2);
    ...
    blas.tpmv(f64, .RowMajor, .Lower, .NoTrans, .Unit, n, A.ptr, x10.ptr, -2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Lower, .NoTrans, .NonUnit, n, A.ptr, x11.ptr, 2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Lower, .NoTrans, .Unit, n, A.ptr, x12.ptr, -2);
    ...
    blas.tpmv(f64, .RowMajor, .Lower, .Trans, .NonUnit, n, A.ptr, x13.ptr, 2);
    ...
    blas.tpmv(f64, .RowMajor, .Lower, .Trans, .Unit, n, A.ptr, x14.ptr, -2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Lower, .Trans, .NonUnit, n, A.ptr, x15.ptr, 2);
    ...
    blas.tpmv(f64, .ColumnMajor, .Lower, .Trans, .Unit, n, A.ptr, x16.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .NoTrans, .NonUnit, n, B.ptr, x17.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .NoTrans, .Unit, n, B.ptr, x18.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .NoTrans, .NonUnit, n, B.ptr, x19.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .NoTrans, .Unit, n, B.ptr, x20.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .ConjNoTrans, .NonUnit, n, B.ptr, x21.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .ConjNoTrans, .Unit, n, B.ptr, x22.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .ConjNoTrans, .NonUnit, n, B.ptr, x23.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .ConjNoTrans, .Unit, n, B.ptr, x24.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .Trans, .NonUnit, n, B.ptr, x25.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .Trans, .Unit, n, B.ptr, x26.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .Trans, .NonUnit, n, B.ptr, x27.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .Trans, .Unit, n, B.ptr, x28.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .ConjTrans, .NonUnit, n, B.ptr, x29.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Upper, .ConjTrans, .Unit, n, B.ptr, x30.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .ConjTrans, .NonUnit, n, B.ptr, x31.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Upper, .ConjTrans, .Unit, n, B.ptr, x32.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .NoTrans, .NonUnit, n, B.ptr, x33.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .NoTrans, .Unit, n, B.ptr, x34.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .NoTrans, .NonUnit, n, B.ptr, x35.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .NoTrans, .Unit, n, B.ptr, x36.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .ConjNoTrans, .NonUnit, n, B.ptr, x37.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .ConjNoTrans, .Unit, n, B.ptr, x38.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .ConjNoTrans, .NonUnit, n, B.ptr, x39.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .ConjNoTrans, .Unit, n, B.ptr, x40.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .Trans, .NonUnit, n, B.ptr, x41.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .Trans, .Unit, n, B.ptr, x42.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .Trans, .NonUnit, n, B.ptr, x43.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .Trans, .Unit, n, B.ptr, x44.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .ConjTrans, .NonUnit, n, B.ptr, x45.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .RowMajor, .Lower, .ConjTrans, .Unit, n, B.ptr, x46.ptr, -2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .ConjTrans, .NonUnit, n, B.ptr, x47.ptr, 2);
    ...
    blas.tpmv(Complex(f64), .ColumnMajor, .Lower, .ConjTrans, .Unit, n, B.ptr, x48.ptr, -2);
