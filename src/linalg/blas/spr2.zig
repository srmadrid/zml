...
test "spr2" {
    ...
    blas.spr2(f64, .RowMajor, .Upper, n, alpha, x1.ptr, 2, y1.ptr, 2, A.ptr);
    ...
    blas.spr2(f64, .RowMajor, .Upper, n, alpha, x2.ptr, -2, y2.ptr, -2, A.ptr);
    ...
    blas.spr2(f64, .ColumnMajor, .Upper, n, alpha, x3.ptr, 2, y3.ptr, 2, A.ptr);
    ...
    blas.spr2(f64, .ColumnMajor, .Upper, n, alpha, x4.ptr, -2, y4.ptr, -2, A.ptr);
    ...
    blas.spr2(f64, .RowMajor, .Lower, n, alpha, x5.ptr, 2, y5.ptr, 2, A.ptr);
    ...
    blas.spr2(f64, .RowMajor, .Lower, n, alpha, x6.ptr, -2, y6.ptr, -2, A.ptr);
    ...
    blas.spr2(f64, .ColumnMajor, .Lower, n, alpha, x7.ptr, 2, y7.ptr, 2, A.ptr);
    ...
    blas.spr2(f64, .ColumnMajor, .Lower, n, alpha, x8.ptr, -2, y8.ptr, -2, A.ptr);
