                    ...
                    while (j < x.cols) : (j += 1) {
                        ...
                        while (i < j) : (i += 1) {
                            if (comptime opinfo.@"fn".params.len == 2) {
                                ...
                                result.data[j + i * result.ld] = op(constants.zero(X, ctx) catch unreachable, y.data[i + j * y.ld]);
                            } else if (comptime opinfo.@"fn".params.len == 3) {
                                result.data[i + j * result.ld] = try op(x.data[i + j * x.ld], y.data[i + j * y.ld], ctx);
                                result.data[j + i * result.ld] = try op(constants.zero(X, ctx) catch unreachable, y.data[i + j * y.ld], ctx);
                            }
                        }
                    ...
                    while (j < x.cols) : (j += 1) {
                        ...
                        while (i < j) : (i += 1) {
                            if (comptime opinfo.@"fn".params.len == 2) {
                                ...
                                result.data[j + i * result.ld] = op(constants.zero(X, ctx) catch unreachable, y.data[i * y.ld + j]);
                            } else if (comptime opinfo.@"fn".params.len == 3) {
                                result.data[i + j * result.ld] = try op(x.data[i + j * x.ld], y.data[i * y.ld + j], ctx);
                                result.data[j + i * result.ld] = try op(constants.zero(X, ctx) catch unreachable, y.data[i * y.ld + j], ctx);
                            }
                        }
                    ...
                    while (i < x.rows) : (i += 1) {
                        ...
                        while (j < x.cols) : (j += 1) {
                            if (comptime opinfo.@"fn".params.len == 2) {
                                ...
                                result.data[j * result.ld + i] = op(constants.zero(X, ctx) catch unreachable, y.data[i + j * y.ld]);
                            } else if (comptime opinfo.@"fn".params.len == 3) {
                                result.data[i * result.ld + j] = try op(x.data[i * x.ld + j], y.data[i + j * y.ld], ctx);
                                result.data[i + j * y.ld] = try op(constants.zero(X, ctx) catch unreachable, y.data[i + j * y.ld], ctx);
                            }
                        }
                    }
                } else { // r ru cl
                    ...
                    while (i < x.rows) : (i += 1) {
                        ...
                        while (j < i) : (j += 1) {
                            if (comptime opinfo.@"fn".params.len == 2) {
                                ...
                                result.data[i * result.ld + j] = try op(x.data[i * x.ld + j], y.data[i + j * y.ld], ctx);
                                result.data[j * result.ld + i] = try op(constants.zero(X, ctx) catch unreachable, y.data[i + j * y.ld], ctx);
                            }
                        }
                    ...
                    while (i < x.rows) : (i += 1) {
                        ...
                        while (j < x.cols) : (j += 1) {
                            if (comptime opinfo.@"fn".params.len == 2) {
                                ...
                                result.data[j * result.ld + i] = op(constants.zero(X, ctx) catch unreachable, y.data[i * y.ld + j]);
                            } else if (comptime opinfo.@"fn".params.len == 3) {
                                result.data[i * result.ld + j] = try op(x.data[i * x.ld + j], y.data[i * y.ld + j], ctx);
                                result.data[j * result.ld + i] = try op(constants.zero(X, ctx) catch unreachable, y.data[i * y.ld + j], ctx);
                            }
                        }
                    }
                } else { // r ru rl
