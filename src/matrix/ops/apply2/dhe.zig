                                ...
                                if (comptime types.isComplex(X)) { // Result is a general matrix
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = op(
                                            x,
                                            ops.conj(y.data[i + j * y.ld], .{}) catch unreachable,
                                        );
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                            ...
                            while (i < j) : (i += 1) {
                                if (comptime opinfo.@"fn".params.len == 2) {
                                    result.data[i + j * result.ld] = op(
                                        x,
                                        ops.conj(y.data[j + i * y.ld], .{}) catch unreachable,
                                    );
                                } else if (comptime opinfo.@"fn".params.len == 3) {
                            ...
                            while (i < j) : (i += 1) {
                                ...
                                if (comptime types.isComplex(X)) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = op(
                                            x,
                                            ops.conj(y.data[i * y.ld + j], .{}) catch unreachable,
                                        );
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j + i * result.ld] = try op(
                                            x,
                        ...
                        while (j < y.size) : (j += 1) {
                            ...
                            while (i < j) : (i += 1) {
                                if (comptime opinfo.@"fn".params.len == 2) {
                                    result.data[i + j * result.ld] = op(
                                        x,
                                        ops.conj(y.data[j * y.ld + i], .{}) catch unreachable,
                                    );
                                } else if (comptime opinfo.@"fn".params.len == 3) {
                                    result.data[i + j * result.ld] = try op(
                                        x,
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) { // cu cu
                        ...
                        while (j < x.size) : (j += 1) {
                            ...
                            while (i < j) : (i += 1) {
                                ...
                                if (comptime types.isComplex(X)) { // Result is a general matrix
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = op(
                                            ops.conj(x.data[i + j * x.ld], .{}) catch unreachable,
                                            y,
                                        );
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j + i * result.ld] = try op(
                        ...
                        while (j < x.size) : (j += 1) {
                            ...
                            while (i < j) : (i += 1) {
                                if (comptime opinfo.@"fn".params.len == 2) {
                                    result.data[i + j * result.ld] = op(
                                        ops.conj(x.data[j + i * x.ld], .{}) catch unreachable,
                                        y,
                                    );
                                } else if (comptime opinfo.@"fn".params.len == 3) {
                                    result.data[i + j * result.ld] = try op(
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) { // cu ru
                        ...
                        while (j < x.size) : (j += 1) {
                            ...
                            while (i < j) : (i += 1) {
                                ...
                                if (comptime types.isComplex(X)) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = op(
                                            ops.conj(x.data[i * x.ld + j], .{}) catch unreachable,
                                            y,
                                        );
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j + i * result.ld] = try op(
                        ...
                        while (j < x.size) : (j += 1) {
                            ...
                            while (i < j) : (i += 1) {
                                if (comptime opinfo.@"fn".params.len == 2) {
                                    result.data[i + j * result.ld] = op(
                                        ops.conj(x.data[j * x.ld + i], .{}) catch unreachable,
                                        y,
                                    );
                                } else if (comptime opinfo.@"fn".params.len == 3) {
                                    result.data[i + j * result.ld] = try op(
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // cu cl cu
                            ...
                            while (j < y.size) : (j += 1) {
                                ...
                                while (i < y.size) : (i += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = ops.conj(op(x.data[i + j * x.ld], y.data[i + j * y.ld]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j + i * result.ld] = ops.conj(try op(x.data[i + j * x.ld], y.data[i + j * y.ld], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // cu cl ru
                            ...
                            while (j < y.size) : (j += 1) {
                                ...
                                while (i < y.size) : (i += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = ops.conj(op(x.data[i + j * x.ld], y.data[i * y.ld + j]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j + i * result.ld] = ops.conj(try op(x.data[i + j * x.ld], y.data[i * y.ld + j], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // cu rl cu
                            ...
                            while (j < y.size) : (j += 1) {
                                ...
                                while (i < y.size) : (i += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = ops.conj(op(x.data[i * x.ld + j], y.data[i + j * y.ld]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j + i * result.ld] = ops.conj(try op(x.data[i * x.ld + j], y.data[i + j * y.ld], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // cu rl ru
                            ...
                            while (i < x.size) : (i += 1) {
                                ...
                                while (j < x.size) : (j += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j + i * result.ld] = ops.conj(op(x.data[i * x.ld + j], y.data[i * y.ld + j]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j + i * result.ld] = ops.conj(try op(x.data[i * x.ld + j], y.data[i * y.ld + j], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // ru cl cu
                            ...
                            while (j < y.size) : (j += 1) {
                                ...
                                while (i < y.size) : (i += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j * result.ld + i] = ops.conj(op(x.data[i + j * x.ld], y.data[i + j * y.ld]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j * result.ld + i] = ops.conj(try op(x.data[i + j * x.ld], y.data[i + j * y.ld], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // ru cl ru
                            ...
                            while (i < x.size) : (i += 1) {
                                ...
                                while (j < x.size) : (j += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j * result.ld + i] = ops.conj(op(x.data[i + j * x.ld], y.data[i * y.ld + j]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j * result.ld + i] = ops.conj(try op(x.data[i + j * x.ld], y.data[i * y.ld + j], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // ru rl cu
                            ...
                            while (i < x.size) : (i += 1) {
                                ...
                                while (j < x.size) : (j += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j * result.ld + i] = ops.conj(op(x.data[i * x.ld + j], y.data[i + j * y.ld]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j * result.ld + i] = ops.conj(try op(x.data[i * x.ld + j], y.data[i + j * y.ld], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
                    ...
                    if (comptime types.uploOf(@TypeOf(x)) == .upper) {
                        ...
                        if (comptime types.uploOf(@TypeOf(y)) == .upper) { // ru rl ru
                            ...
                            while (i < x.size) : (i += 1) {
                                ...
                                while (j < x.size) : (j += 1) {
                                    if (comptime opinfo.@"fn".params.len == 2) {
                                        result.data[j * result.ld + i] = ops.conj(op(x.data[i * x.ld + j], y.data[i * y.ld + j]), .{}) catch unreachable;
                                    } else if (comptime opinfo.@"fn".params.len == 3) {
                                        result.data[j * result.ld + i] = ops.conj(try op(x.data[i * x.ld + j], y.data[i * y.ld + j], ctx), .{}) catch unreachable;
                                    }
                                }
                            }
                        }
