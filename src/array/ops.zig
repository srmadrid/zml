...
pub inline fn eq(
    ...
    return apply2(allocator, x, y, ops.eq, .{});
}
...
pub inline fn ne(
    ...
    return apply2(allocator, x, y, ops.ne, .{});
}
...
pub inline fn lt(
    ...
    return apply2(allocator, x, y, ops.lt, .{});
}
...
pub inline fn le(
    ...
    return apply2(allocator, x, y, ops.le, .{});
}
...
pub inline fn gt(
    ...
    return apply2(allocator, x, y, ops.gt, .{});
}
...
pub inline fn ge(
    ...
    return apply2(allocator, x, y, ops.ge, .{});
}
