...
fn k_apply1IntoUnchecked(
    ...
    if (numeric.abs(o.strides[o.ndim - 1]) <= numeric.abs(o.strides[0]))
        stridedLoop(o, x, opInto, noconj_o, noconj_x, true, 0, 0, 0)
    else
        stridedLoop(o, x, opInto, noconj_o, noconj_x, false, 0, 0, 0);
}
...
fn stridedLoop(
    ...
    var curr_x = x_offset;
    for (0..o.shape[dim]) |_| {
        stridedLoop(o, x, opInto, noconj_o, noconj_x, is_c_order, curr_o, curr_x, level + 1);
