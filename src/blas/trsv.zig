...
pub inline fn trsv(comptime T: type, order: Order, uplo: Uplo, transA: Transpose, diag: Diag, n: isize, A: [*]const T, lda: isize, x: [*]T, incx: isize) void {
    ...
    switch (supported) {
        .BuiltinBool => @compileError("blas.trsv does not support bool."),
        ...
        .CustomInt, .CustomReal, .CustomComplex, .CustomExpression => @compileError("blas.trsv only supports simple types."),
...
test "trsv" {
    ...
    blas.trsv(f64, .RowMajor, .Upper, .NoTrans, .NonUnit, n, A.ptr, n, x1.ptr, 2);
    ...
    blas.trsv(f64, .RowMajor, .Upper, .NoTrans, .Unit, n, A.ptr, n, x2.ptr, -2);
    ...
    blas.trsv(f64, .ColumnMajor, .Upper, .NoTrans, .NonUnit, n, A.ptr, n, x3.ptr, 2);
    ...
    blas.trsv(f64, .ColumnMajor, .Upper, .NoTrans, .Unit, n, A.ptr, n, x4.ptr, -2);
    ...
    blas.trsv(f64, .RowMajor, .Upper, .Trans, .NonUnit, n, A.ptr, n, x5.ptr, 2);
    ...
    blas.trsv(f64, .RowMajor, .Upper, .Trans, .Unit, n, A.ptr, n, x6.ptr, -2);
    ...
    blas.trsv(f64, .ColumnMajor, .Upper, .Trans, .NonUnit, n, A.ptr, n, x7.ptr, 2);
    ...
    blas.trsv(f64, .ColumnMajor, .Upper, .Trans, .Unit, n, A.ptr, n, x8.ptr, -2);
    ...
    blas.trsv(f64, .RowMajor, .Lower, .NoTrans, .NonUnit, n, A.ptr, n, x9.ptr, 2);
    ...
    blas.trsv(f64, .RowMajor, .Lower, .NoTrans, .Unit, n, A.ptr, n, x10.ptr, -2);
    ...
    blas.trsv(f64, .ColumnMajor, .Lower, .NoTrans, .NonUnit, n, A.ptr, n, x11.ptr, 2);
    ...
    blas.trsv(f64, .ColumnMajor, .Lower, .NoTrans, .Unit, n, A.ptr, n, x12.ptr, -2);
    ...
    blas.trsv(f64, .RowMajor, .Lower, .Trans, .NonUnit, n, A.ptr, n, x13.ptr, 2);
    ...
    blas.trsv(f64, .RowMajor, .Lower, .Trans, .Unit, n, A.ptr, n, x14.ptr, -2);
    ...
    blas.trsv(f64, .ColumnMajor, .Lower, .Trans, .NonUnit, n, A.ptr, n, x15.ptr, 2);
    ...
    blas.trsv(f64, .ColumnMajor, .Lower, .Trans, .Unit, n, A.ptr, n, x16.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .NoTrans, .NonUnit, n, B.ptr, n, x17.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .NoTrans, .Unit, n, B.ptr, n, x18.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .NoTrans, .NonUnit, n, B.ptr, n, x19.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .NoTrans, .Unit, n, B.ptr, n, x20.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .ConjNoTrans, .NonUnit, n, B.ptr, n, x21.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .ConjNoTrans, .Unit, n, B.ptr, n, x22.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .ConjNoTrans, .NonUnit, n, B.ptr, n, x23.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .ConjNoTrans, .Unit, n, B.ptr, n, x24.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .Trans, .NonUnit, n, B.ptr, n, x25.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .Trans, .Unit, n, B.ptr, n, x26.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .Trans, .NonUnit, n, B.ptr, n, x27.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .Trans, .Unit, n, B.ptr, n, x28.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .ConjTrans, .NonUnit, n, B.ptr, n, x29.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Upper, .ConjTrans, .Unit, n, B.ptr, n, x30.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .ConjTrans, .NonUnit, n, B.ptr, n, x31.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Upper, .ConjTrans, .Unit, n, B.ptr, n, x32.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .NoTrans, .NonUnit, n, B.ptr, n, x33.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .NoTrans, .Unit, n, B.ptr, n, x34.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .NoTrans, .NonUnit, n, B.ptr, n, x35.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .NoTrans, .Unit, n, B.ptr, n, x36.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .ConjNoTrans, .NonUnit, n, B.ptr, n, x37.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .ConjNoTrans, .Unit, n, B.ptr, n, x38.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .ConjNoTrans, .NonUnit, n, B.ptr, n, x39.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .ConjNoTrans, .Unit, n, B.ptr, n, x40.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .Trans, .NonUnit, n, B.ptr, n, x41.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .Trans, .Unit, n, B.ptr, n, x42.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .Trans, .NonUnit, n, B.ptr, n, x43.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .Trans, .Unit, n, B.ptr, n, x44.ptr, -2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .ConjTrans, .NonUnit, n, B.ptr, n, x45.ptr, 2);
    ...
    blas.trsv(Complex(f64), .RowMajor, .Lower, .ConjTrans, .Unit, n, B.ptr, n, x46.ptr, -2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .ConjTrans, .NonUnit, n, B.ptr, n, x47.ptr, 2);
    ...
    blas.trsv(Complex(f64), .ColumnMajor, .Lower, .ConjTrans, .Unit, n, B.ptr, n, x48.ptr, -2);
