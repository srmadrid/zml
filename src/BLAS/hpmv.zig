...
test "hpmv" {
    ...
    BLAS.hpmv(Complex(f64), .RowMajor, .Upper, n, alpha, A.ptr, x1.ptr, 1, beta, y1.ptr, 1);

    try std.testing.expectEqual(-7, y1[0].re);
    try std.testing.expectEqual(215, y1[0].im);
    try std.testing.expectEqual(-17, y1[1].re);
    try std.testing.expectEqual(361, y1[1].im);
    try std.testing.expectEqual(-33, y1[2].re);
    try std.testing.expectEqual(339, y1[2].im);
    try std.testing.expectEqual(-23, y1[3].re);
    try std.testing.expectEqual(467, y1[3].im);
    try std.testing.expectEqual(-59, y1[4].re);
    try std.testing.expectEqual(551, y1[4].im);
    ...
    BLAS.hpmv(Complex(f64), .ColumnMajor, .Upper, n, alpha, A.ptr, x2.ptr, -1, beta, y2.ptr, 2);

    try std.testing.expectEqual(59, y2[0].re);
    try std.testing.expectEqual(223, y2[0].im);
    try std.testing.expectEqual(-46, y2[2].re);
    try std.testing.expectEqual(336, y2[2].im);
    try std.testing.expectEqual(-49, y2[4].re);
    try std.testing.expectEqual(385, y2[4].im);
    try std.testing.expectEqual(13, y2[6].re);
    try std.testing.expectEqual(519, y2[6].im);
    try std.testing.expectEqual(-83, y2[8].re);
    try std.testing.expectEqual(567, y2[8].im);
    ...
    BLAS.hpmv(Complex(f64), .RowMajor, .Lower, n, alpha, A.ptr, x3.ptr, 1, beta, y3.ptr, -2);

    try std.testing.expectEqual(-97, y3[8].re);
    try std.testing.expectEqual(211, y3[8].im);
    try std.testing.expectEqual(-2, y3[6].re);
    try std.testing.expectEqual(340, y3[6].im);
    try std.testing.expectEqual(-15, y3[4].re);
    try std.testing.expectEqual(391, y3[4].im);
    try std.testing.expectEqual(-95, y3[2].re);
    try std.testing.expectEqual(515, y3[2].im);
    try std.testing.expectEqual(-9, y3[0].re);
    try std.testing.expectEqual(573, y3[0].im);
    ...
    BLAS.hpmv(Complex(f64), .ColumnMajor, .Lower, n, alpha, A.ptr, x4.ptr, -2, beta, y4.ptr, -1);

    try std.testing.expectEqual(-29, y4[4].re);
    try std.testing.expectEqual(213, y4[4].im);
    try std.testing.expectEqual(-33, y4[3].re);
    try std.testing.expectEqual(361, y4[3].im);
    try std.testing.expectEqual(-29, y4[2].re);
    try std.testing.expectEqual(335, y4[2].im);
    try std.testing.expectEqual(-47, y4[1].re);
    try std.testing.expectEqual(475, y4[1].im);
    try std.testing.expectEqual(-33, y4[0].re);
    try std.testing.expectEqual(549, y4[0].im);
}
