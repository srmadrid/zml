...
Check all BLAS functions are correctly tested (especially the old ones: replace with the 2 and -2 incx tests). From `hbmv` they follow the new (preferred) format and, therefore, have correct tests.
